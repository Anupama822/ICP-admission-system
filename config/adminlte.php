...
return [
    ...
    */
    ...
    'logo_img_class' => 'brand-image opacity-100 shadow rounded-circle',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs opacity-100',
    ...
    */
    ...
    'assets' => [
        ...
        'local' => [
            ...
            'fonts_css' => 'https://fonts.bunny.net/css?family=plus-jakarta-sans:400,500,600,700,800',
        ],
    ...
    */
    ...
    'css_variables' => [
        // ICP brand palette
        '--icp-white'               => '#fff',
        '--icp-highlight-heading'   => '#9F0D1A',
        '--icp-general'             => '#676767',
        '--icp-heading'             => '#484848',
        '--icp-btn'                 => '#8D2229',
        '--icp-highlight'           => '#971F20',
        '--icp-bg'                  => '#FBFBFB',
        '--icp-hover'               => '#971F20',
        // Bootstrap primary override → ICP crimson
        '--bs-primary'              => '#8D2229',
        '--bs-primary-rgb'          => '141,34,41',
        '--bs-link-color'           => '#8D2229',
        '--bs-link-hover-color'     => '#971F20',
        '--bs-body-bg'              => '#FBFBFB',
    ...
    'css_variables_sidebar' => [
        '--lte-sidebar-bg'           => '#1a0a0b',
        '--lte-sidebar-color'        => '#d1adb0',
        '--lte-sidebar-hover-bg'     => '#2d1316',
        '--lte-sidebar-hover-color'  => '#ffffff',
        '--lte-sidebar-active-bg'    => '#8D2229',
        '--lte-sidebar-active-color' => '#ffffff',
        '--lte-sidebar-header-color' => '#a07075',
    ],
    ...
    */
    ...
    'classes_auth_card' => 'shadow-lg border-0',
    'classes_auth_header' => '',
    'classes_auth_body' => '',
    'classes_auth_footer' => '',
    'classes_auth_icon' => '',
