...
@section('index_content')
    ...
    <p class="icp-page-subtitle small mb-0 mt-3 d-flex align-items-center gap-2">
        ...
        <span>Click a title or year to edit it right here &mdash; <kbd>Enter</kbd> saves, <kbd>Esc</kbd> cancels.</span>
    </p>
...
@push('scripts')
    ...
    <script>
        (function ($) {
            ...
            var TABLE = '#admission-years-table';
            ...
            // ── Row actions ───────────────────────────────────────────────────
            $(document).on('click', TABLE + ' .js-activate', function () {
                var button = $(this);
                ...
                $.ajax({
                    ...
                    toast(errorFrom(xhr, 'Could not activate this admission year.'), 'danger');
                });
            });
            ...
            $(document).on('click', TABLE + ' .js-delete', function () {
                ...
                if (!window.confirm('Delete the admission year "' + button.data('title') + '"? This cannot be undone.')) {
                    return;
                }
                ...
                $.ajax({
                    ...
                    toast(errorFrom(xhr, 'Could not delete this admission year.'), 'danger');
                });
            });
        })(jQuery);
    </script>
